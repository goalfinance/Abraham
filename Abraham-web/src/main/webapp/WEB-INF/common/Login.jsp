    ...
    <div class="row bs-reset">
        ...
        <div class="col-md-6 login-container bs-reset">
            <div class="login-content">
                <h1>Abraham项目管理登录</h1>
                <p> "我虽然行过死阴的幽谷，也不怕遭害。因为你与我同在。你的杖，你的竿，都安慰我。"</p>
                <p> -- 诗篇 23章4节 </p>
                <form action="javascript:;" class="login-form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 text-right">
                            ...
                            <button class="btn green" type="submit" onclick="loginSubmit()">登录</button>
                        </div>
                    </div>
                </form>
...
<script src="../assets/global/plugins/jquery.serialize-object.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
