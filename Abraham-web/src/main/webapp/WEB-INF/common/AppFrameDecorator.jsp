...
<div class="page-container">
                ...
                <li class="nav-item start active open">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item start ">
                            <a href="/data/dashboard/show" class="nav-link ">
                                <i class="icon-bulb"></i>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END THEME PANEL -->
            <!-- BEGIN FACILITY CONTENT BODY-->
            <sitemesh:write property='body'/>
            <!-- END FACILITY CONTENT BODY-->
        </div>
        <!-- END CONTENT BODY -->
    </div>
    <!-- END CONTENT -->
...
<div class="page-footer">
    <div class="page-footer-inner"> 2016 &copy; Abraham, Father of Faith.
...
<script src="/assets/global/plugins/horizontal-timeline/horozontal-timeline.min.js"
        type="text/javascript"></script>
